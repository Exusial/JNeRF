...
Rays = collections.namedtuple(
    'Rays',
    ('origins', 'directions', 'viewdirs', 'radii', 'lossmult', 'near', 'far', 'cam_idx', 'exposure_idx', 'exposure_values'))
...
def sorted_piecewise_constant_pdf(bins, weights, num_samples, randomized):
    ...
    #     u += jt.array(np.random.uniform(0, 1, list(cdf.shape[:-1]) + [num_samples])) # random no autograd. No effects here.
